...
public class BadgeView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundColor = typedArray.getColor(R.styleable.BadgeView_mbtv_backgroundColor, Color.WHITE);
        borderColor = typedArray.getColor(R.styleable.BadgeView_mbtv_border_color, Color.TRANSPARENT);
        borderWidth = typedArray.getDimension(R.styleable.BadgeView_mbtv_border_width, 0);
        borderAlpha = typedArray.getFloat(R.styleable.BadgeView_mbtv_border_alpha, 1);
        ctType = typedArray.getInt(R.styleable.BadgeView_mbtv_type, DEFAULT_FILL_TYPE);
        typedArray.recycle();
    }
